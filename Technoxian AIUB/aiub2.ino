...
// float kp = 1.7, kd = 206500;  //pid parameter ,need to be adjust 1.68 100
//
...
#define u_turn_delay 115   //delay for u turn                                    Adjust this value to get perfact result
int node_delay =20;     //to make perfact 90 degree turn                    ----------------------------------------------
#define stop_timer 90    // stop delay if find end point                     ----------------------------------------------  
...
void loop() {
  ...
  // else if (btn_press == 4) {
  //   motor(250, 250); delay(1500);
  //   motor(0, 0);

  //   //    autotune();
  // }
  else if (btn_press == 5) {
    motor(200, 200); delay(2000);
    motor(0, 0);
  }
